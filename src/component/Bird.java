...
public class Bird {
    ...
    public void draw(Graphics g) {
        ...
        g.drawImage(image, x - halfImgWidth, y - halfImgHeight, null); // x 坐标于窗口 1/4 处, y 坐标位窗口中心
    ...
    public static final int ACC_FLAP = 14; // 玩家拍打 (翅膀) 时的速度
    public static final double ACC_Y = 2; // 玩家向下的加速度
    public static final int MAX_VEL_Y = 15; // 沿 Y 轴的最大速度, 即最大下降速度
    private int velocity = 0; // 小鸟沿 Y 轴的速度, 默认值与玩家拍打 (翅膀) 时的速度相同
    ...
    public void deadBirdFall() {
        ...
        velocity = 0;  // 速度置 0, 防止小鸟继续上升与水管重叠
    }
    ...
    private boolean keyFlag = true; // 按键状态, true 为已释放, 使当按住按键时不会重复调用方法
